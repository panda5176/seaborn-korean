...
- [복잡한 데이터셋의 다변량 시각](introduction#복잡한-데이터셋의-다변량-시각)
...
- [그림 수준 함수 대 축 수준 함수](function_overview#그림-수준-함수-대-축-수준-함수)
- [데이터의 여러 시각을 결합하기](function_overview#데이터의-여러-시각을-결합하기)
...
### [그림 미학 조절하기](aesthetics)

- [씨본 그림 스타일](aesthetics#씨본-그림-스타일)
- [축 테두리 제거하기](aesthetics#축-테두리-제거하기)
- [일시적으로 그림 스타일 설정하기](aesthetics#일시적으로-그림-스타일-설정하기)
